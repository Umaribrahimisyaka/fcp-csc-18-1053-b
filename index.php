...
<html lang="en">
	<head>
	    ...
	    <title>FUD E-Market Home Page</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Free Delivery within Campus</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">All items-sale up to 10% off  for New Customers</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
				Naira:<?php echo htmlentities($row['productPrice']);?>			</span>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
												Naira: <?php echo htmlentities($row['productPrice']);?>
												</span>
