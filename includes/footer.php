...
<h3>FUD E-Market System</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Federal University Dutse E-Market System</p>
...
<div class="contact-information">
	<div class="module-heading">
		<h4 class="module-title">Contact Info</h4>
	</div><!-- /.module-heading -->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
                ...
                <div class="media-body">
                    <p>FUD E-Market System, <br>Old Cafeteria, FUD.</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@fudemarket.com</a></span>
                </div>
            </li>
